        ...
        <div class="col-md-12 d-flex align-items-center justify-content-between">
          <div class="project-title d-flex align-items-center edit">
            ...
            {{ Form::label('tags', 'feed tags:', array('class' => 'Form-control col-md-3')) }} {{ Form::textarea('tags', $feed->tags, array('class' => 'Form-control col-md-8', 'rows'=>'1')) }}
              ...
              {{ Form::label('feed_url', 'feed url:', array('class' => 'Form-control col-md-3')) }} {{ Form::textarea('feed_url', $feed->feed_url, array('class' => 'Form-control col-md-8', 'rows'=>'1')) }}

          <div class="row well">
          {{ Form::submit('Save', ["class"=>"btn btn-success btn-block"]) }}
            {!! Form::close() !!}</div>
            <div class="row well">{!! Form::open(['route'=>['feeds.destroy', $feed->id], 'method'=> 'DELETE'])!!}
